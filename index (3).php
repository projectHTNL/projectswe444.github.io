...
<table    style="relative:center;top;width:400px;height:100%;" cellspacing="0" cellpadding="2" border="0" bordercolor="#FFFFFF">
 ...
 <tr align="center" width="400">   Employee Search Children Vaccinations</tr>
...
$query="SELECT * FROM   children_vaccinations WHERE employeeid='$employeeid'";
...
echo "<td width='700'><a href='http://localhost:8080/Employeeserchchildrenvac/delete.php?vac_id=" . $row[0] . "'>Delete</a></td>";
