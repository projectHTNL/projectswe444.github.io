...
<table    style="relative:center;top;width:400px;height:100%;" cellspacing="0" cellpadding="2" border="0" bordercolor="#FFFFFF">
 ...
 <tr align="center" width="400">   Staff contact centers</tr>
...
$query="SELECT * FROM   healthcentercontactstaff WHERE recieve IS NULL";
$r= mysqli_query($con,$query);
if(!$r)
{
echo"<script type='text/javascript'>\n";
echo"alert('you are not succesflly Search Staff NESSAGES try again!!!!!');\n";
echo"</script>";
}
else
{echo"<script type='text/javascript'>\n";
echo"alert('you are succesflly Search Staff NESSAGES!!!!!');\n";
echo"</script>";
}
...
echo '<td width="100">'.'<font color="Brown" size="3">'."Staff Id".'</font>'.'</td>';
...
echo '<td width="400">'.'<font color="black" size="3">'."$row[5]\n<br>".'</font>'.'</td>';



echo "<td width='700'><a href='http://localhost:8080/healthcenteraddstaffreply/index.php?id=" . $row[0] . "'>Add Reply</a></td>";
