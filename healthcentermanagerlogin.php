...
$_SESSION['NationalID']=$NationalID;			
           ...
           $mys=" SELECT * FROM healthcentermanager WHERE id='$NationalID' AND email='$Email' AND password='$password' AND Ischecked='1'"; 
		   $result=mysqli_query($conn,$mys);
		   $count=mysqli_num_rows($result);
		   if($count == 1){
						header("location:http://localhost:8080/Healthcentermanagerfunctions/");   
		   }
		   else{
