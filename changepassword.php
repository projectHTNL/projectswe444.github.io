...
$confirmpassword=$_POST['conps'];
          $mys=" SELECT * FROM healthcenterstaff WHERE password='$oldpassword' AND national_id='$id'"; 
		   $result=mysqli_query($con,$mys);
		   $count=mysqli_num_rows($result);
		   if($count == 1){

	if($newpassword==$confirmpassword){
$query="UPDATE healthcenterstaff SET password='$newpassword' WHERE national_id='$id'  ";
